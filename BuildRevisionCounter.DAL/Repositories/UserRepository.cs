...
namespace BuildRevisionCounter.DAL.Repositories
{
    public class UserRepository : BaseRepository<UserModel>, IUserRepository
    {
        ...
        private static readonly string[] AdminRoles = { Enums.AdminRoles.admin.ToString(), Enums.AdminRoles.buildserver.ToString(), Enums.AdminRoles.editor.ToString() };
        ...
        public async Task CreateOneAsync()
        {
